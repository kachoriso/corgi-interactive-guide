  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
        messages: [
            {
                role: "system",
                content: "あなたは創造的なコーギーの専門家です。ユーザーの指示に従い、ユニークで魅力的なコーギーの名前と、その短い由来を創作してください。必ず「名前：(名前)、由来：(由来)」の形式で、必ず日本語で回答してください。"
            },
            {
                role: "user",
  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
        messages: [
            {
                role: "system",
                content: "あなたは賢くてユーモアのあるコーギーの達人です。ユーザーが観察したコーギーの行動を翻訳し、そのコーギーが何を考えているかを楽しく想像力豊かに説明してください。必ず日本語で、簡潔に2～3文でお願いします。"
            },
            {
                role: "user",
