  ...
  try {
    const chatCompletion = await groq.chat.completions.create({
        messages: [
            {
                role: "system",
                content: "あなたは創造的なコーギーの専門家です。ユーザーの指示に従い、ユニークで魅力的なコーギーの名前と、その短い由来を創作してください。あなたの回答は、必ず日本語でなければなりません。回答形式は「名前：(名前)、由来：(由来)」を厳守してください。"
            },
            {
                role: "user",
  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
        messages: [
            {
                role: "system",
                content: "あなたは賢くてユーモアのあるコーギーの達人です。ユーザーが観察したコーギーの行動を翻訳し、そのコーギーが何を考えているかを楽しく想像力豊かに説明してください。あなたの回答は、必ず日本語で、簡潔な2～3文でなければなりません。英語は一切使用しないでください。"
            },
            {
                role: "user",
